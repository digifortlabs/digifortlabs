...
| **Ch 8: Medical Records Department (MRD) & Telemedicine** | ICD-10/11 coding, S3 discharge-date hierarchy (`{Hospital}/MRD/YYYY/MM/`), dynamic S3 file relocation, physical file barcode tracking, archive vault, WhatsApp E-Rx. | **Fully Implemented (100%)** | Discharge-date S3 relocation in [`storage_service.py`](file:///d:/Website/DIGIFORTLABS/backend/app/services/storage_service.py#L205). UHID readmission suffixing in [`id_generator.py`](file:///d:/Website/DIGIFORTLABS/backend/app/services/id_generator.py#L102). Soft-delete in [`storage.py`](file:///d:/Website/DIGIFORTLABS/backend/app/routers/storage.py). |
