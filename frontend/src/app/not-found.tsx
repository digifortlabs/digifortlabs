...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-12 rounded-xl shadow-2xl max-w-lg w-full animate-in zoom-in-95 duration-300">
