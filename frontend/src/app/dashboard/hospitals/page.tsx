                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {loading ? (
                            ...
                            <tr key={h.hospital_id} className="hover:bg-slate-50/50 transition-colors relative group">
                                ...
                                <td className="px-8 py-5 text-right">
                                    <div className="relative inline-block text-left">
                                        <button
                                            onClick={() => setActiveActionId(activeActionId === h.hospital_id ? null : h.hospital_id)}
