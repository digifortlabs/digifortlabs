...
export default function WarehousePage() {
    ...
    const handleRealScan = async () => {
        ...
        try {
            // Search for patient
            const res = await fetch(`${API_URL}/patients/?q=${encodeURIComponent(scanInput)}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
        ...
        <div className="p-6 max-w-[1600px] mx-auto min-h-screen pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-2">Physical inventory tracking and aisle management.</p>
                </div>
                ...
                {activeTab === 'warehouse' && (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="flex justify-between items-end">
                            <div>
                                <h2 className="text-2xl font-black text-slate-800">MRD Physical Map</h2>
                                <p className="text-slate-400 font-medium">Visual occupancy and capacity monitoring</p>
                            </div>
                    ...
                    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="bg-white rounded-[2.5rem] overflow-hidden border border-slate-200 shadow-sm">
                            <div className="p-8 bg-indigo-600 text-white text-center relative overflow-hidden">
                                <h2 className="text-2xl font-black relative z-10">MRD Scan Station</h2>
                                <p className="text-indigo-100 text-sm opacity-80 relative z-10">Process file movements via QR scanner or manual entry</p>
                                <Scan className="absolute -bottom-6 -right-6 w-32 h-32 text-white opacity-10 rotate-12" />
                            </div>
