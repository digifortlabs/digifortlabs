...
import { Upload, X, Loader2, PlayCircle, FileType, CheckCircle, Stethoscope, Activity, Plus, Trash2, Search, Syringe } from 'lucide-react';
    ...
    return (
        <div className="flex-1 p-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                {(userRole === 'website_staff' || userRole === 'data_uploader' || userRole === 'website_admin' || userRole === 'hospital_admin') && (
                    <div className="mt-8 pt-8 border-t border-gray-100">
                        ...
                        <div className={`relative group transition-all duration-300 ${isUploading ? 'opacity-50 pointer-events-none grayscale' : 'opacity-100'}`}>
                            ...
                            <div className="relative bg-white border-2 border-dashed border-slate-200 hover:border-indigo-300 rounded-xl p-6 text-center transition-all cursor-pointer overflow-hidden">
                                ...
                                <p className="text-[10px] text-slate-400 font-medium">PDF, MP4, MOV, MKV (Max 100MB)</p>
                            </div>
                        </div>
