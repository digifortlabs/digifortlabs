    ...
    const loadData = async () => {
        ...
        try {
            ...
            const [w, a] = await Promise.all([
                ...
                apiFetch(`hms/admissions/active${suffix}`).catch(() => []),
            ]);
            setWards(w || []);
            setAdmissions(a || []);
        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto pb-24">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-3 items-center flex-wrap">
                    ...
                    <Button onClick={() => router.push('/hospital/hms/admissions')} variant="outline" className="gap-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50">
                    ...
                    <Card className="border-slate-200/60 shadow-sm">
                        <CardHeader className="border-b pb-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="ghost" size="sm" className="text-blue-600 text-xs" onClick={() => router.push('/hospital/hms/admissions')}>View all</Button>
                            </div>
                        </CardHeader>
