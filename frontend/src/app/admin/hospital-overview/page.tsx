                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <ModuleAccessCard 
                                ...
                                status="active"
                                icon={<Database />}
                                href={`/admin/records?hospital_id=${hospitalId}`}
                            />
                            <ModuleAccessCard 
                                ...
                                status="active"
                                icon={<Package />}
                                href={`/admin/archive?hospital_id=${hospitalId}`}
                            />
                            <ModuleAccessCard 
                                ...
                                status="active"
                                icon={<IndianRupee />}
                                href={`/admin/platform-billing?hospital_id=${hospitalId}`}
                            />
                            <ModuleAccessCard 
                                ...
                                status="active"
                                icon={<AppWindow />}
                                href={`/admin?hospital_id=${hospitalId}`}
                            />
                        </div>
                    </div>
