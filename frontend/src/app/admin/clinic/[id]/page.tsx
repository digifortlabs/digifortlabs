...
export default function ClinicPatientDetail() {
    ...
    const [newRx, setNewRx] = useState({ medicine_name: '', dosage: '', frequency: '1-0-0', duration: '', instructions: 'After meals' });
    ...
    const addPrescription = () => {
        ...
        setNewRx({ medicine_name: '', dosage: '', frequency: '1-0-0', duration: '', instructions: 'After meals' });
    };
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-2 mt-1">
                                                {[
                                                    { label: 'Morning (1-0-0)', value: '1-0-0' },
                                                    { label: 'Night (0-0-1)', value: '0-0-1' },
                                                    { label: 'Morning & Night (1-0-1)', value: '1-0-1' },
                                                    { label: 'Thrice a Day (1-1-1)', value: '1-1-1' }
                                                ].map((opt) => (
                                                    <label
                                                        key={opt.value}
                                                        className={`text-center py-1.5 px-2 rounded-lg border text-[11px] font-bold cursor-pointer transition-all duration-150 ${
                                                            newRx.frequency === opt.value
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            name="frequency"
                                                            value={opt.value}
                                                            checked={newRx.frequency === opt.value}
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="flex gap-2 mt-1">
                                                {['After meals', 'Before meals', 'With meals'].map((opt) => (
                                                    <label
                                                        key={opt}
                                                        className={`flex-1 text-center py-1.5 px-3 rounded-lg border text-xs font-bold cursor-pointer transition-all duration-150 ${
                                                            newRx.instructions === opt
                                                                ? 'bg-blue-600 border-blue-600 text-white shadow-sm shadow-blue-500/20'
                                                                : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'
                                                        }`}
                                                    >
                                                        <input
                                                            ...
                                                            name="timing"
                                                            value={opt}
                                                            checked={newRx.instructions === opt}
