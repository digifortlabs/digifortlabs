    ...
    return (
        <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8 bg-white min-h-screen">
            ...
            <div className="flex items-center justify-between print:hidden">
                <Link href="/admin/platform-billing" className="flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors font-bold uppercase text-xs tracking-widest">
