...
def process_s3_optimization(key, level="BALANCED"):
    ...
    print(f"Decrypted: {os.path.getsize(temp_pdf)/1024:.2f} KB")
    print(f"Optimized: {os.path.getsize(output_pdf)/1024:.2f} KB")
    print(f"Final Encrypted: {os.path.getsize(final_enc)/1024:.2f} KB")
