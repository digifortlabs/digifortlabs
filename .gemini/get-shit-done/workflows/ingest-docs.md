...
```bash
INIT=$(node "D:/Website/DIGIFORTLABS/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/Website/DIGIFORTLABS/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
