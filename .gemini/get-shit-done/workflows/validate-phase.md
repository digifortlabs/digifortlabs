...
```
Agent(
  prompt="Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/VALIDATION.md`
