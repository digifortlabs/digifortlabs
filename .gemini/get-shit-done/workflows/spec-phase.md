...
```bash
INIT=$(node "D:/Website/DIGIFORTLABS/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/spec.md.
