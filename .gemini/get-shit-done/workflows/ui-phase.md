...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-ui-checker.md for instructions.
