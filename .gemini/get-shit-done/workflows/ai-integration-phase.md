...
<required_reading>
@D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/ai-frameworks.md
@D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Website/DIGIFORTLABS/.gemini/agents/gsd-eval-planner.md for instructions.
