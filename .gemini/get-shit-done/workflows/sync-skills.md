...
INSTALL_JS_GLOBAL="D:/Website/DIGIFORTLABS/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Website/DIGIFORTLABS/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
