...
- Usage: Reference from command with `@D:/Website/DIGIFORTLABS/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Website/DIGIFORTLABS/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Website/DIGIFORTLABS/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
