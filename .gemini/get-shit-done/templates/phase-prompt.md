...
<!-- For checkpoint task examples and patterns, see @D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
