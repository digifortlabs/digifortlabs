...
Reference full template: `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/templates/state.md`.
