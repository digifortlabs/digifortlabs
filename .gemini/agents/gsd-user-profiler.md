...
<reference>
@D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Website/DIGIFORTLABS/.gemini/get-shit-done/references/user-profiling.md` to load:
